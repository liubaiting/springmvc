...
import com.liubt.ssm.service.LogInfoService;
...
public class LogInfoServiceImpl implements LogInfoService {
    ...
    @Override
    @Before("execution(* com.liubt.ssm.service.impl.*.*(..))")
    ...
    @Override
    @AfterReturning("execution(* com.liubt.ssm.service.impl.*.*(..))")
    ...
    @Override
    @AfterThrowing("execution(* com.liubt.ssm.service.impl.*.*(..))")
    ...
    @Override
    @After("execution(* com.liubt.ssm.service.impl.*.*(..))")
    ...
    @Override
    @Around("execution(* com.liubt.ssm.service.impl.*.*(..))")
